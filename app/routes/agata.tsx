...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    {
      name: "description",
      content: "Tygodniowe menu i lista zakupów dla Agaty",
    },
  ];
}

export default function Agata() {
  const {
    days,
    selectedDays,
    multiplier,
  ...
  } = useWeeklyMenu(originalWeeklyMenu, "agata");
  ...
  return (
    <div className='container mx-auto py-6 px-4'>
      ...
      <Card className='mb-6'>
        <CardHeader>
          <CardTitle>Menu Agaty</CardTitle>
          <CardDescription>
          ...
          <Card>
            ...
            <CardContent>
              <ScrollArea className='h-100'>
                <Table>
                  <TableCaption>
                    Całkowita ilość składników potrzebnych dla Agaty
                  </TableCaption>
                  <TableHeader>
                    <TableRow>
